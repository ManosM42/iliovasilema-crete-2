...
const dict = {
  el: {
    ...
    "intro.body": "Στην καρδιά της Κρήτης, χιλιόμετρα από το Ενετικό Λιμάνι, το Iliovasilema είναι ένα διαμέρισμα όπου η κρητική φιλοξενία συναντά τη σύγχρονη πολυτέλεια. Πανοραμική θέα στα κρητικά τοπία, ιδιωτική βεράντα, και εκείνο το χρυσό φως του δειλινού που έδωσε στο σπίτι το όνομά του.",
