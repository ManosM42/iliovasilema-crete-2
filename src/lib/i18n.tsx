...
const dict = {
  el: {
    ...
    "nav.entertainment": "Κοντινή Ψυχαγωγία",
    ...
    "intro.body": "Στην καρδιά της Κρήτης, λίγα βήματα από το χιλιόμετρα από το Ενετικό λιμάνο Λιμάνι, το Iliovasilema είναι ένα διαμέρισμα όπου η κρητική φιλοξενία συναντά τη σύγχρονη πολυτέλεια. Πανοραμική θέα στα κρητικά τοπία, ιδιωτική βεράντα, και εκείνο το χρυσό φως του δειλινού που έδωσε στο σπίτι το όνομά του.",
    ...
    "card.entertainment": "Κοντινή Ψυχαγωγία",
    ...
    "back.entertainment": "← Κοντινή Ψυχαγωγία",
    "badge.beach": "Παραλία",
    "badge.attraction": "Αξιοθέατο",
    "badge.restaurant": "Εστιατόριο",
    "badge.entertainment": "Ψυχαγωγία",
  ...
  en: {
    ...
    "nav.entertainment": "Nearby Entertainment",
    "nav.contact": "Contact",
    ...
    "intro.body": "In the heart of Crete, few kilometres from the Venetian Harbor, Iliovasilema is an apartment where Cretan hospitality meets quiet, modern luxury. Panoramic view of the cretan Landscapes, a private terrace, and the golden hour light that gave this home its name.",
    ...
    "card.entertainment": "Nearby Entertainment",
    ...
    "back.entertainment": "← Nearby Entertainment",
    "badge.beach": "Beach",
    "badge.attraction": "Attraction",
    "badge.restaurant": "Restaurant",
    "badge.entertainment": "Entertainment",
